...
//                 <p className="text-amber-100 font-light text-lg">123, ABC Colony, Chennai - 600028</p>
//               </div>
//             </div>
...
import React, { useState } from 'react';
import { FiMapPin, FiPhone, FiMail, FiMessageSquare, FiGlobe, FiArrowRight } from 'react-icons/fi';
import toast, { Toaster } from 'react-hot-toast';
import { contactFormFields } from '../../assets/dummydata';
    ...
    <div className="min-h-screen bg-gradient-to-r from-orange-900 via-amber-900 to-green-900 animate-gradient-x py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 font-[Poppins] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Contact Info */}
          <div className="space-y-6">
            <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl border-l-4 border-amber-500">
              ...
              <p className="text-amber-100 text-lg pl-12">
                123, ABC Colony, Chennai - 600028
              </p>
            </div>

            <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl border-l-4 border-green-500">
              <div className="flex items-center mb-4">
              ...
              <div className="pl-12 text-amber-100">
                <FiGlobe className="inline text-green-400 mr-2" />
                +91 9791903195
              </div>
            </div>

            <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl border-l-4 border-orange-500">
              <div className="flex items-center mb-4">
              ...
              <p className="text-amber-100 pl-12">
                aparnaapar99@gmail.com
              </p>
            </div>
          </div>
          ...
          {/* Contact Form */}
          <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border-2 border-amber-500/30">
            <form onSubmit={handleSubmit} className="space-y-6">

              {contactFormFields.map(({ label, name, type, placeholder, pattern, Icon }) => (
                <div key={name}>
                  <label className="block text-amber-100 text-sm mb-2">
                    {label}
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={formData[name]}
                      onChange={handleChange}
                      className="w-full pl-10 pr-4 py-3 bg-white/10 border-2 border-amber-500/30 rounded-xl text-amber-50 placeholder-amber-200/50"
                      placeholder={placeholder}
                      pattern={pattern}
                      required
                    />
              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute left-3 top-4">
                    <FiMessageSquare className="text-amber-500 text-xl" />
                  </div>
                  <textarea
                    rows="4"
                    name="query"
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-amber-600 to-orange-600 text-white font-semibold py-3 px-6 rounded-xl flex items-center justify-center gap-2"
              >
                <span>Submit Query</span>
